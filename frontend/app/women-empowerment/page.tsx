...
export default function WomenFarmers() {
  const resources = [
    ...
    {
      title: "Health & Safety",
      desc: "Agriculture mein mahilaon ki sehat aur suraksha ke liye guide.",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {resources.map((item, i) => (
            <motion.div
              key={i}
              whileHover={{ y: -5 }}
              className="p-8 rounded-[2rem] border border-white/5 bg-white/[0.02] backdrop-blur-xl hover:border-rose-500/30 transition-all group"
            >
              ...
              <button className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest text-rose-400 opacity-0 group-hover:opacity-100 transition-all">
